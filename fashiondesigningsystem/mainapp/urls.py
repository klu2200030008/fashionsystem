...
urlpatterns = [
    ...
    path("kidswear/", mykidswear, name='refrences'),
    path("ladieswear/", myladieswear, name='traditionalwear'),
    ...
    path('login_view/ladieswear.html', myladieswear, name='traditionalwear_in_login'),
    path('login_view/kidswear.html', mykidswear, name='traditionalwear_in_login'),
    path('login_view/menswear.html', mymenswear, name='traditionalwear_in_login'),
    path('home1/menswear.html', mymenswear, name='traditionalwear_in_login'),
    path('home1/ladieswear.html', myladieswear, name='traditionalwear_in_login'),
    path('home1/kidswear.html', mykidswear, name='traditionalwear_in_login'),
